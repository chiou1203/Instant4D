...
WORK_DIR="${WORK_DIR:-$REPO_ROOT/SLAM/medium}"
PRUNE_DIR="${PRUNE_DIR:-$REPO_ROOT/SLAM/voxel_filter/output/colab}"
MODEL_DIR="${MODEL_DIR:-$REPO_ROOT/output/colab/$SCENE_NAME}"
